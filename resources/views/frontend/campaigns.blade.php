                    ...
                    <div class="row"> 
                        ...
                        <div class="col-lg-5 col-md-5 hidden-sm hidden-xs">
                            <div class="event-latest-thumbnail">
                                <a href="#">
                                    <img src="{{ asset('assets/images/event_1.jpg') }}" alt="">
                                </a>
                            </div>
                        </div> <!--  col-sm-5  -->
                ...
                <div class="event-latest ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-5 hidden-sm hidden-xs">
                            <div class="event-latest-thumbnail">
                                <a href="#">
                                    <img src="{{ asset('assets/images/event_2.jpg') }}" alt="">
                                </a>
                            </div>
                        </div> <!--  col-sm-5  -->
                ...
                <div class="event-latest">
                    <div class="row"> 
                        ...
                        <div class="col-lg-5 col-md-5 hidden-sm hidden-xs">
                            <div class="event-latest-thumbnail">
                                <a href="#">
                                    <img src="{{ asset('assets/images/event_3.jpg') }}" alt="">
                                </a>
                            </div>
                        </div> <!--  col-sm-5  -->
                ...
                <div class="event-latest">
                    ...
                    <div class="row"> 
                        <div class="col-lg-5 col-md-5 hidden-sm hidden-xs">
                            <div class="event-latest-thumbnail">
                                <a href="#">
                                    <img src="{{ asset('assets/images/event_4.jpg') }}" alt="">
                                </a>
                            </div>
                        </div> <!--  col-sm-5  -->
